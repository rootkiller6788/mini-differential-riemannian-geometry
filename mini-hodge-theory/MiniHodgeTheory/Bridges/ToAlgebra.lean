/-
# MiniHodgeTheory: Bridges -- To Algebra -- L7
Hodge structures, Mumford-Tate groups, algebraic cycles.
-/
import MiniHodgeTheory.Theorems.Classification
namespace MiniHodgeTheory

def algebraBridge : List String := [
  "Hodge structures on cohomology of algebraic varieties",
  "Mumford-Tate group: algebraic group encoding symmetries",
  "Algebraic cycles to Hodge classes via cycle class map",
  "Hodge conjecture: rational Hodge classes are algebraic",
  "Mixed Hodge structures (Deligne) for arbitrary varieties",
  "Tannakian category of Hodge structures",
  "Period domains = G_R/K classify Hodge structures",
  "Griffiths transversality for algebraic families"
]

#eval "---- Bridges.ToAlgebra ----"
#eval s!"Algebra connections: {algebraBridge.length}"
