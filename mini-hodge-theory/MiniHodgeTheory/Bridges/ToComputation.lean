/-
# MiniHodgeTheory: Bridges -- To Computation -- L7
Discrete Hodge theory, spectral methods, algorithms.
-/
import MiniHodgeTheory.Properties.ClassificationData
namespace MiniHodgeTheory

def compBridge : List String := [
  "Finite element exterior calculus (FEEC): discrete Hodge theory",
  "Discrete Hodge star on simplicial complexes",
  "Spectral methods: Laplacian eigenvalues = topological info",
  "Persistent Hodge Laplacians: multi-scale harmonic analysis",
  "HodgeRank: statistical ranking via Hodge decomposition",
  "Numerical Hodge decomposition for PDE on forms",
  "Isospectral manifolds: same spectrum, different topology",
  "Combinatorial Hodge theory on graphs"
]

#eval "---- Bridges.ToComputation ----"
#eval s!"Computational connections: {compBridge.length}"
