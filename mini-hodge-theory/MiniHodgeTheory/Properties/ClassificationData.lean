/-
# MiniHodgeTheory: Properties -- ClassificationData -- L5
Hodge diamond classification, K3 surfaces, Hodge conjecture.
-/
import MiniHodgeTheory.Core.Basic
namespace MiniHodgeTheory

def CPnHodgeNumbers (p q : Nat) : Nat :=
  if p = q then 1 else 0

def K3HodgeDiamond : List (List Nat) := [
  [1], [0, 0], [1, 20, 1], [0, 0], [1]
]

def hodgeConjecture : String :=
...
#eval s!"K3 Hodge diamond: {K3HodgeDiamond}"
#eval s!"Hodge conjecture: {hodgeConjecture}"
