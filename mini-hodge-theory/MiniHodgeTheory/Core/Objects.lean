/-
# MiniHodgeTheory: Object Registrations -- L1/L6
-/
...
def hodgeTheoryName : MiniObjectKernel.TheoryName :=
  MiniObjectKernel.TheoryName.ofString "DifferentialGeometry.HodgeTheory"

instance : MiniObjectKernel.Object RealVec where
  theory := hodgeTheoryName
  objName := "RealVec"
  repr v := toString v

instance : MiniObjectKernel.Object LinearMap where
  theory := hodgeTheoryName
  objName := "LinearMap"
  repr _ := "LinearMap"

instance : MiniObjectKernel.Object DiffOperator where
  theory := hodgeTheoryName
  objName := "DiffOperator"
  repr _ := "DiffOp"

instance : MiniObjectKernel.Object AdjointPair where
  theory := hodgeTheoryName
  objName := "AdjointPair"
  repr _ := "AdjPair"

def registeredObjects : List String := [
  "RealVec", "LinearMap", "AdjointPair", "DiffOperator",
  "InnerProductSpace", "HodgeStar", "VolumeForm"
]

#eval "---- Core.Objects: Hodge Theory Objects ----"
#eval s!"Registered: {registeredObjects}"
