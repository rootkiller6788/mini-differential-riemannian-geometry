/-
# Theorems.MeyersBonnet - Myers and Bonnet-Myers
-/
...
#eval "== Myers / Bonnet-Myers =="
#eval s!"K=1: diam <= {myersBound 1} (S^2: pi)"
#eval s!"K=4: diam <= {myersBound 4}"
#eval s!"K=0.25: diam <= {myersBound 0.25}"
#eval "Ric >= (n-1)K>0 => diam<=pi/sqrt(K), compact, pi_1 finite"
#eval "-- MeyersBonnet complete --"
