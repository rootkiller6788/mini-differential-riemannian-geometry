/-
# Theorems.CartanHadamard - Cartan-Hadamard
-/
...
#eval "== Cartan-Hadamard Theorem =="
#eval "sec<=0, simply connected => diffeomorphic to R^n"
#eval s!"sn_(-1)(10)=sinh(10)={Float.sinh 10} > 0 (no zeros)"
#eval "K<=0 => no conjugate points"
#eval "pi_1 of K<=0 manifolds is torsion-free"
#eval "-- CartanHadamard complete --"
