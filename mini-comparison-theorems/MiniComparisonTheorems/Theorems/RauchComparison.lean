/-
# Theorems.RauchComparison - Rauch Comparison
-/
...
#eval "== Rauch Comparison =="
#eval "Rauch I: sec <= K => |J| >= sn_K"
#eval "Rauch II: sec >= K => |J| <= sn_K"
#eval s!"K1=1,K2=4: sn1(0.5)={sn_K 1 0.5} >= sn4(0.5)={sn_K 4 0.5}"
#eval s!"K1=-1,K2=1: sn_(-1)(0.5)={sn_K (-1) 0.5} >= sn1(0.5)={sn_K 1 0.5}"
#eval "-- RauchComparison complete --"
