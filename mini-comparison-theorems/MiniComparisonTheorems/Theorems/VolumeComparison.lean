/-
# Theorems.VolumeComparison - Bishop-Gromov
-/
...
#eval "== Bishop-Gromov Volume Comparison =="
#eval "Ric >= (n-1)K => Vol ratio nonincreasing"
#eval s!"K=1,R=0.5,n=2: ratio={volumeRatio 1 0.5 2}"
#eval "K=0: ratio=1 (Euclidean)"
#eval s!"K=-1,R=0.5,n=2: ratio={volumeRatio (-1) 0.5 2}"
#eval "-- VolumeComparison complete --"
