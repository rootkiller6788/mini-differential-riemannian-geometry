/-
# Morphisms.IndexForm - Index Form and Second Variation
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems

#eval "Index form: I(V,V) = Integral (|V|^2 - sec |V|^2)"
#eval "Second variation of energy = index form"
#eval "Jacobi fields: I(J,J) = 0 (critical points)"
#eval "Before 1st conjugate point: I > 0 (positive definite)"
#eval "Morse index = number of negative eigenvalues"
#eval ""
#eval "Test function sin(pi*t/T) on [0,T] with curvature K:"
#eval "  I = pi^2/(2T) - K*T/2"
#eval "  Zero when T = pi/sqrt(K) (first conjugate point)"
#eval ""
#eval "Index comparison: sec <= K => I_M >= I_K"
#eval "Cartan-Hadamard: sec <= 0 => I >= Integral|V|^2 > 0"
#eval "-- IndexForm complete --"
