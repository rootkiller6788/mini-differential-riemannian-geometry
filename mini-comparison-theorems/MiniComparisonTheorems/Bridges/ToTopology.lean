/-
# Bridges.ToTopology - Topological Implications
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems
#eval "== Topological Implications =="
#eval "sec>0 => pi_1 finite (Bonnet-Myers)"
#eval "Synge: even-dim, orientable, sec>0 => simply connected"
#eval "Sphere theorem: 1/4-pinched + simply connected => S^n"
#eval "Hopf conjecture: S^2xS^2 admit sec>0? -- OPEN"
