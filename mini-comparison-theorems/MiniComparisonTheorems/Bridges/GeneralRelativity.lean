/-
# Bridges.GeneralRelativity - GR Applications
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems
#eval "=== General Relativity Bridge ==="
#eval "Raychaudhuri: dtheta/dtau + theta^2/3 + Ric(v,v) = 0"
#eval "SEC => theta -> -infinity (singularity)"
#eval "Singularity theorems = Lorentzian comparison"
#eval "de Sitter (K>0), Minkowski (K=0), AdS (K<0)"
#eval "-- GeneralRelativity complete --"
