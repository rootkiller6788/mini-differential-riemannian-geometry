/-
# Bridges.GeometricAnalysis - Spectral Geometry
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems
#eval "=== Geometric Analysis ==="
#eval "Cheeger-Yau: heat kernel comparison"
#eval "Cheng: lambda_1 >= n*K when Ric >= (n-1)K"
#eval "Levy-Gromov: isoperimetric inequality via vol comparison"
#eval "LSV: Ricci bounds via optimal transport"
#eval "-- GeometricAnalysis complete --"
