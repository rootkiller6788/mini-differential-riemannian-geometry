/-
# Bridges.AlexandrovGeometry - CAT(k) and CBB(k)
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems
#eval "=== Alexandrov Geometry ==="
#eval "CAT(k): curvature <= k (metric spaces)"
#eval "CBB(k): curvature >= k (metric spaces)"
#eval "GH-limits: Riemannian -> Alexandrov (stability)"
#eval "LSV: synthetic Ricci via optimal transport"
#eval "-- AlexandrovGeometry complete --"
