/-
# Core.GeodesicEquation - Geodesics and Exponential Map
-/
...
#eval "Geodesic equation: d^2x/dt^2 + Gamma(dx/dt)(dx/dt) = 0"
#eval "Exponential map: exp_p(v) = geodesic starting at p with velocity v"
#eval "Jacobi equation: D^2J/dt^2 + R(J,gamma)gamma = 0"
#eval "Conjugate points: J(0)=J(t0)=0 for nonzero Jacobi field J"
#eval ""
#eval "Model space geodesics:"
#eval "  S^n: great circles, diameter = pi*r"
#eval "  R^n: straight lines, infinite diameter"
#eval "  H^n: hyperbolic lines, infinite diameter"
#eval ""
#eval "Hopf-Rinow: complete <-> closed bounded subsets are compact"
#eval "Gauss Lemma: radial geodesics orthogonal to geodesic spheres"
#eval ""
#eval "-- GeodesicEquation complete --"
