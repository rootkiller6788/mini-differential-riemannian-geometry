/-
# Constructions.GeodesicCoordinates - Normal Coordinates
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems

#eval "Normal coordinate expansion: g_{ij} = delta_{ij} - (1/3)R_{ikjl} x^k x^l + ..."
#eval "Volume: det(g) = 1 - (1/3)Ric_{kl} x^k x^l + ..."
#eval ""
#eval "S^n: cut locus = antipodal point (distance pi*r)"
#eval "R^n: no cut locus (infinite injectivity radius)"
#eval "H^n: no cut locus"
#eval ""
#eval "Geodesic polar coordinates: ds^2 = dr^2 + g_{ab}(r,theta) dtheta^a dtheta^b"
#eval "dV = det(A(r)) dr dtheta, A + R A = 0"
#eval "Model spaces: A(r) = sn_K(r) * I"
#eval "-- GeodesicCoordinates complete --"
