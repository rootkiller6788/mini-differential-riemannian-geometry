/-
# Properties.VolumeEntropy - Volume Entropy
-/
import MiniComparisonTheorems.Core.Basic
namespace MiniComparisonTheorems

#eval "=== Volume Entropy ==="
#eval "h_vol = limsup (1/R) log Vol(B(R))"
#eval "K>0: h_vol = 0 (finite volume)"
#eval "K=0: h_vol = 0 (polynomial)"
#eval "K<0: h_vol = (n-1)sqrt(-K) (exponential)"
#eval "sec<0 => geodesic flow is Anosov (chaotic)"
#eval "h_top = h_vol for sec<=0 (Dinaburg-Manning)"
#eval "-- VolumeEntropy complete --"
