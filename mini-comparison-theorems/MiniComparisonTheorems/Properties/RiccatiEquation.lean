/-
# Properties.RiccatiEquation - Riccati Equation
-/
...
#eval "Riccati: s + s^2/(n-1) + Ric(gamma,gamma) = 0"
#eval "theta = tr(S) = (n-1) csn_K/sn_K (model spaces)"
#eval "Comparison: Ric >= (n-1)K => theta <= theta_K"
#eval ""
#eval "Volume: V/V = theta/(n-1)"
#eval "Continuous => Volume ratio nonincreasing (Bishop-Gromov)"
#eval ""
#eval "Raychaudhuri (Lorentzian): dtheta/dtau + theta^2/3 + Ric(v,v) = 0"
#eval "Energy condition => theta -> -infinity (singularity)"
#eval "-- RiccatiEquation complete --"
