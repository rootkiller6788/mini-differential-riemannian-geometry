/-
# Examples.MoreComparisons - Additional Examples
-/
...
#eval "=========================================="
#eval "  MORE COMPARISON EXAMPLES"
#eval "=========================================="
#eval "== Small Ball Expansion =="
#eval "Vol = omega_n r^n (1 - Ric r^2/(6(n+2)) + ...)"
#eval "== Sphere Theorems =="
#eval "Berger-Klingenberg: 1/4-pinched + simply connected => S^n"
#eval "Brendle-Schoen: same => diffeomorphic to S^n"
#eval "== Soul Theorem =="
#eval "sec >= 0 noncompact => M = normal bundle of compact soul S"
#eval "R^n: soul={origin}, S^n x R: soul=S^n"
#eval "== Eigenvalue Comparison =="
#eval "Ric >= (n-1)K => lambda_1 >= n*K (Cheng)"
#eval "S^2(1): lambda_1 = 2, S^2(2): lambda_1 = 0.5"
#eval "-- MoreComparisons complete --"
